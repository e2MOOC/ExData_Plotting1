...
## Plot1
# plot graph
plot(dd$Global_active_power, type="l",xaxt="n",xlab="", ylab="Global Active Power (kilowatts)")
# add axis
...
# plot lines
lines(dd$Sub_metering_1, col="black")
...
## Plot3
# plot graph
plot(dd$Voltage, type="l",xaxt="n",xlab="datetime", ylab="Voltage")
# add axis
axis(1, at=c(1, as.integer(nrow(dd)/2), nrow(dd)), labels=c("Thu", "Fri", "Sat"))

## Plot4
# plot graph
plot(dd$Global_reactive_power, type="l",xaxt="n",xlab="datetime", ylab="Global_reactive_power")
# add axis
axis(1, at=c(1, as.integer(nrow(dd)/2), nrow(dd)), labels=c("Thu", "Fri", "Sat"))
